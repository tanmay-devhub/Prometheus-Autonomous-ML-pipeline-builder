...
from backend.agents.code_generator import code_generator_node

FIX_PROMPT_TEMPLATE = """You are fixing a broken ML pipeline script.
...
async def fix_executor_node(
    ...
    # If the same failure recurs on retry 2+ → the patch approach is stuck; regenerate from scratch
    ...
    if should_regenerate:
        ...
        # code_generator_node already validates internally
        ...
        # One corrective pass if validation fails
