...
from classification.config import ALLOWED_TASK_TYPES, ALLOWED_METRICS
...
Your job is to return a JSON object with exactly these fields:
{
  ...
  "evaluation_metric": "roc_auc" | "f1" | "accuracy" | "pr_auc" | "log_loss",
  "confidence": 0.0-1.0,
...
Rules:
- task_type MUST always be "binary_classification" — this service only handles classification
...
- evaluation_metric should be roc_auc by default unless the user specifies otherwise
