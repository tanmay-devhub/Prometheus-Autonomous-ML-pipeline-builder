...
import RegressionModelCard from "../components/regression/RegressionModelCard";
import EndpointViewer from "../components/EndpointViewer";
import PipelineProgress from "../components/PipelineProgress";
import RegressionTestPanel from "../components/regression/RegressionTestPanel";
import {
    ...
    <div className="flex items-center justify-between px-8 pt-5 pb-2 shrink-0">
      <div className="flex items-center gap-3">
        <button onClick={() => router.push("/")} className="flex items-center gap-3 hover:opacity-80 transition-opacity">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-accent-violet to-accent-blue flex items-center justify-center">
          ...
          <div>
            ...
            <div className="eyebrow text-[9.5px] -mt-px text-accent-violet">regression</div>
          </div>
        </button>
        {jobId && (
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 text-ink-400">
          <svg width="13" height="13" viewBox="0 0 24 24" className={polling ? "spin-slow" : ""}>
            ...
            <path d="M12 3a9 9 0 0 1 9 9" stroke="#8B5CF6" strokeWidth="2" strokeLinecap="round" fill="none"/>
          </svg>
          ...
          <motion.div key={view}
            ...
            {view === "upload" && (
              <UploadPanel
                ...
                taskDescription="Predict numbers: house prices, salaries, temperatures, sales"
              />
            )}
            ...
            {view === "results" && (
              <motion.div className="max-w-[1280px] mx-auto px-8 py-6 space-y-5">
                <div className="flex items-end justify-between mb-2">
                  ...
                  <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-accent-violet/10 border border-accent-violet/30 text-accent-violet">
                    <span className="dot bg-accent-violet pulse-dot" /><span className="text-[11px] font-mono">processing</span>
                  </div>
                </div>
                {modelCardData && explanationData && (
                  <RegressionModelCard
                    ...
                    successMetrics={{
                      r2: explanationData.r2,
                      rmse_pct_of_mean: explanationData.rmse_pct_of_mean,
                      within_10_pct: explanationData.within_10_pct,
                      within_15_pct: explanationData.within_15_pct,
                      within_20_pct: explanationData.within_20_pct,
                      mae: explanationData.mae,
                      target_mean: explanationData.target_mean,
                    }}
                  />
                )}
                <DebugLog debugLog={debugLog} />
              ...
              <motion.div className="max-w-[1280px] mx-auto px-8 py-6 space-y-5">
                <div className="flex items-end justify-between mb-2">
                  <div>
                    ...
                    <div className="text-ink-400 text-[13.5px] mt-1.5">Your regressor is trained, packaged, and ready to call.</div>
                  </div>
            ...
            {view === "failed" && (
              <motion.div className="max-w-[1080px] mx-auto px-8 py-8 relative">
                ...
                <div className="text-[26px] font-semibold tracking-tight mt-1 mb-6">Pipeline failed</div>
